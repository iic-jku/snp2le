...
class DesignView(QtWidgets.QWidget):
    ...
    def __init__(self, parent=None):
        ...
        self.tabs.addTab(self.ngspice_edit, "Ngspice")
        self.tabs.addTab(self.vacask_edit, "VACASK")
        ...
        self.exp_va = QtWidgets.QPushButton("Export VACASK"); self.exp_va.setObjectName("primary")
